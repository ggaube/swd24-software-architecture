...
public class SchoolService {
    ...
    public FullSchoolResponse callingStudentServiceUsingRESTTemplate(Integer schoolId) {
        // to make the call of student service dynamic, we can use this
        // discoveryClient bean, but not load balanced
...
//        String url = serviceInstance.getUri().toString() + "/api/v1/students";
        ...
        //using the LoadBalancerClient, we can load balancing the call of
        // the service target instances
